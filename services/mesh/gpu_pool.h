...
private:
    /// Discover local GPUs via /dev/straylight-vpu* or sysfs.
    ...
    /// Execute a VPU ioctl allocation on a local GPU.
    ...
    /// Transfer data between two local GPUs via P2P DMA.
