...
void NodeRegistry::register_builtins() {
    // camera-capture: compositor screen capture → raw video frames
    register_node({
        .name = "camera-capture",
        .description = "Capture screen or camera via compositor",
        .input_type = "none",
        ...
        .launch_command = "straylight-compositor --capture",
        .is_builtin = true
    });
