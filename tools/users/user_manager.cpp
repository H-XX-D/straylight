...
Result<std::vector<UserAccount>, std::string> UserManager::list_users(
    ...
    if (lastlog_res.has_value()) {
        ...
        while (std::getline(stream, line)) {
            ...
            // "username  pts/0  192.168.1.1  Mon Mar 15 10:30:45 +0000 2024"
...
Result<std::vector<LoginRecord>, std::string> UserManager::login_history(
    ...
    while (std::getline(stream, line)) {
        ...
        // Format: "username  pts/0  192.168.1.1  Mon Mar 15 10:30 - 11:30 (01:00)"
        // or:     "username  pts/0  192.168.1.1  Mon Mar 15 10:30   still logged in"
        std::istringstream ls(line);
