...
static int cmd_start(straylight::IpcJsonClient& client, int argc, char* argv[]) {
    std::string corr_id;
...
static int cmd_stop(straylight::IpcJsonClient& client) {
    nlohmann::json request;
    request["jsonrpc"] = "2.0";
    request["id"] = 1;
    request["method"] = "stop";
...
static int cmd_show(straylight::IpcJsonClient& client, int argc, char* argv[]) {
    if (argc < 3) {
...
static int cmd_export(straylight::IpcJsonClient& client, int argc, char* argv[]) {
    if (argc < 3) {
...
static int cmd_bottleneck(straylight::IpcJsonClient& client, int argc, char* argv[]) {
    if (argc < 3) {
...
static int cmd_live(straylight::IpcJsonClient& client) {
    nlohmann::json request;
    request["jsonrpc"] = "2.0";
    request["id"] = 1;
    request["method"] = "live";
