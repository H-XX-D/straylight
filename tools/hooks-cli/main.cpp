...
static void print_usage() {
    std::cerr
        << "straylight-hooks — system event hook manager CLI\n"
        << "\n"
        << "Usage:\n"
        << "  straylight-hooks list\n"
        << "  straylight-hooks add <event> <script> [--priority <n>] [--timeout <s>]\n"
        << "  straylight-hooks remove <id>\n"
        << "  straylight-hooks test <event>\n"
        << "  straylight-hooks history\n"
        << "\n"
