...
// Forward declarations for ext-session-lock-v1 types
...
void ext_session_lock_v1_unlock_and_destroy(
    struct ext_session_lock_v1* lock);
struct ext_session_lock_surface_v1* ext_session_lock_v1_get_lock_surface(
    struct ext_session_lock_v1* lock,
    struct wl_surface* surface,
    struct wl_output* output);
void ext_session_lock_surface_v1_ack_configure(
    struct ext_session_lock_surface_v1* surface,
    uint32_t serial);
void ext_session_lock_surface_v1_destroy(
    struct ext_session_lock_surface_v1* surface);
}
