// /Users/hendrixx./Desktop/Straylight/apps/snapshot-gui/main.cpp
...
int main(int, char*[]) {
    ...
    xdg_toplevel_set_app_id(ws.toplevel, "straylight-snapshot");
    ...
    while (g_running.load(std::memory_order_relaxed)) {
        ...
        constexpr ImGuiWindowFlags kWinFlags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize |
            ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBringToDisplayFront;
