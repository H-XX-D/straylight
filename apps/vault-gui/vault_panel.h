...
struct VaultState {
    ...
    void init() {
        secrets.push_back({"system/db/password", "s3cur3_db_p@ss", "2026-01-15 10:30", "2026-03-10 14:22", false});
        secrets.push_back({"system/api/token", "tok_a8f3b2c1d4e5", "2026-02-01 09:00", "2026-03-12 11:45", false});
        secrets.push_back({"system/ssh/private_key", "-----BEGIN RSA PRIVATE KEY-----...", "2026-01-20 16:00", "2026-01-20 16:00", false});
        secrets.push_back({"user/email/smtp_pass", "em@il_p4ss!", "2026-02-14 08:15", "2026-03-01 09:30", false});
        secrets.push_back({"user/vpn/certificate", "-----BEGIN CERTIFICATE-----...", "2026-03-01 12:00", "2026-03-01 12:00", false});
        secrets.push_back({"services/redis/auth", "r3d1s_auth_k3y", "2026-02-20 14:00", "2026-02-20 14:00", false});
        secrets.push_back({"services/mqtt/password", "mqt7_br0k3r", "2026-03-05 10:00", "2026-03-05 10:00", false});
        secrets.push_back({"deploy/registry/token", "ghcr_tok_xyz789", "2026-03-10 08:00", "2026-03-10 08:00", false});
        apply_filter();
    }
