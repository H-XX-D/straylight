...
void ServicePanel::init_service_list() {
    ...
    static const SvcDef defs[] = {
        {"straylight-core",      "Core",         "Kernel subsystem manager"},
        {"straylight-bus",       "Bus",          "Inter-process message bus"},
        {"straylight-registry",  "Registry",     "Service registry and discovery"},
        {"straylight-scheduler", "Scheduler",    "Process and GPU scheduler"},
        {"straylight-entropy",   "Entropy",      "Random number generator"},
        {"straylight-alice",     "Alice",        "AI system health monitor"},
        {"straylight-autotune",  "Autotune",     "Hardware performance tuner"},
        {"straylight-flux",      "Flux",         "Realtime data stream processor"},
        {"straylight-swarm",     "Swarm",        "Multi-GPU mesh manager"},
        {"straylight-remote",    "Remote",       "Remote access daemon"},
        {"straylight-compositor","Compositor",    "Wayland compositor"},
        {"straylight-shell",     "Shell",        "Desktop shell"},
    };
