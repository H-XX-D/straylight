...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    xdg_toplevel_set_app_id(ws.toplevel, "straylight-hub");
    ...
    style.Colors[ImGuiCol_Header] = ImVec4(0.0f, 0.4f, 0.3f, 0.5f);
    style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.0f, 0.6f, 0.4f, 0.6f);
    style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.0f, 0.7f, 0.5f, 0.8f);
    ...
    while (g_running.load(std::memory_order_relaxed)) {
        ...
        if (ImGui::Begin("Hub", nullptr, wflags)) {
            ...
            ImGui::TextColored(ImVec4(0.4f, 0.4f, 0.4f, 1.0f),
                              "Central Dashboard & Control Panel");
            ImGui::Separator();
            ...
            if (ImGui::BeginTabBar("HubTabs")) {
                ...
                if (ImGui::BeginTabItem("Settings")) {
                    ...
                    if (ImGui::CollapsingHeader("Appearance", ImGuiTreeNodeFlags_DefaultOpen)) {
                        ...
                        const char* themes[] = {"StrayLight Dark", "StrayLight Light", "Neon", "Solarized"};
                        ImGui::Combo("Theme", &theme_idx, themes, 4);
